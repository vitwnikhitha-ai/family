  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div>
        ...
        <p className="text-white/70 text-sm mt-1">Update personal settings, view roles, and handle administrative security.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-3">
          <div className="bg-saas-card border border-saas-border rounded-2xl p-4 shadow-saas-card space-y-1">
            <h4 className="text-[10px] font-extrabold text-white/70 uppercase tracking-wider px-3 mb-2">General Settings</h4>
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-bold transition-all text-left cursor-pointer ${
                activeTab === 'account' 
                  ...
                  : 'text-white/70 hover:bg-saas-bg hover:text-white'
              }`}
            >
          ...
          {activeTab === 'account' && (
            <div className="bg-saas-card border border-saas-border rounded-2xl p-6 shadow-saas-card space-y-6">
              <div className="flex items-center gap-3 border-b border-saas-border pb-4">
                ...
                <div>
                  <h3 className="font-extrabold text-white text-base tracking-tight">Profile & Account</h3>
                  <p className="text-white/70 text-xs mt-0.5">Overview of your logged-in credentials and family profile link status.</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    <span className="block text-[10px] font-extrabold text-white/70 uppercase tracking-wider mb-1">Username</span>
                    <div className="px-4 py-2.5 bg-saas-bg border border-saas-border rounded-xl text-xs font-bold text-white">
                      {user?.username}
                    </div>
                  </div>

                  <div>
                    <span className="block text-[10px] font-extrabold text-white/70 uppercase tracking-wider mb-1">System Privilege</span>
                    <div className="flex items-center gap-2">
                      <span className={`text-[10px] font-black px-2.5 py-1 rounded-lg border uppercase tracking-wider ${
                        isAdmin 
                          ...
                          : 'bg-saas-bg text-white/70 border-saas-border'
                      }`}>
                ...
                <div className="space-y-4">
                  <span className="block text-[10px] font-extrabold text-white/70 uppercase tracking-wider mb-1">Linked Genealogy Profile</span>
                  ...
                  {linkedProfile ? (
                    <div className="bg-saas-bg/40 border border-saas-border p-4 rounded-xl flex items-center gap-3.5">
                      ...
                      <div>
                        <h4 className="font-bold text-xs text-white">{linkedProfile.fullName}</h4>
                        <span className="text-[9px] font-black text-saas-primary uppercase tracking-wider block mt-0.5">{linkedProfile.relation}</span>
                        <span className="text-[10px] text-white/70 block mt-1">{linkedProfile.occupation || 'No job specified'}</span>
                      </div>
                    </div>
                  ) : (
          ...
          {activeTab === 'security' && (
            <div className="bg-saas-card border border-saas-border rounded-2xl p-6 shadow-saas-card space-y-6">
              <div className="flex items-center gap-3 border-b border-saas-border pb-4">
                ...
                <div>
                  <h3 className="font-extrabold text-white text-base tracking-tight">Security & Credentials</h3>
                  <p className="text-white/70 text-xs mt-0.5">Change your system login credentials here to ensure your account security.</p>
                </div>
              </div>
              ...
              <form onSubmit={handlePasswordChange} className="space-y-4 max-w-md">
                ...
                {/* Current password */}
                <div>
                  <label className="block text-xs font-bold text-white uppercase tracking-wider mb-1">Current Password</label>
                  <div className="relative">
                    <input 
                      ...
                      required
                      className="w-full pl-3.5 pr-10 py-2.5 bg-saas-bg border border-saas-border rounded-xl text-sm focus:outline-none focus:border-saas-primary text-white placeholder-saas-text-secondary/60 font-mono"
                ...
                {/* New password */}
                <div>
                  <label className="block text-xs font-bold text-white uppercase tracking-wider mb-1">New Password</label>
                  <div className="relative">
                    <input 
                ...
                <div>
                  <label className="block text-xs font-bold text-white uppercase tracking-wider mb-1">Confirm New Password</label>
                  <input 
                    type="password"
                    value={passwordData.confirmPassword}
                    onChange={(e) => setPasswordData(prev => ({ ...prev, confirmPassword: e.target.value }))}
                    required
                    className="w-full px-3.5 py-2.5 bg-saas-bg border border-saas-border rounded-xl text-sm focus:outline-none focus:border-saas-primary text-white placeholder-saas-text-secondary/60 font-mono"
          ...
          {activeTab === 'users' && isAdmin && (
            <div className="bg-saas-card border border-saas-border rounded-2xl p-6 shadow-saas-card space-y-6">
              <div className="flex items-center gap-3 border-b border-saas-border pb-4">
                ...
                <div>
                  <h3 className="font-extrabold text-white text-base tracking-tight">Register Family Login</h3>
                  <p className="text-white/70 text-xs mt-0.5">Create software access credentials and link them to family genealogy profile nodes.</p>
                </div>
              </div>
              ...
              <form onSubmit={handleRegisterUser} className="space-y-4 max-w-xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {/* Username */}
                  <div>
                    <label className="block text-xs font-bold text-white uppercase tracking-wider mb-1">Username</label>
                    <input 
                      type="text"
                      value={regData.username}
                      onChange={(e) => setRegData(prev => ({ ...prev, username: e.target.value }))}
                      required
                      className="w-full px-3.5 py-2.5 bg-saas-bg border border-saas-border rounded-xl text-sm focus:outline-none focus:border-saas-primary text-white placeholder-saas-text-secondary/60"
                  ...
                  {/* Password */}
                  <div>
                    <label className="block text-xs font-bold text-white uppercase tracking-wider mb-1">Password</label>
                    <input 
                      type="password"
                  ...
                  {/* System Role */}
                  <div>
                    <label className="block text-xs font-bold text-white uppercase tracking-wider mb-1">System Role</label>
                    <select 
                      value={regData.role}
                      onChange={(e) => setRegData(prev => ({ ...prev, role: e.target.value }))}
                      className="w-full px-3.5 py-2.5 bg-saas-bg border border-saas-border rounded-xl text-sm focus:outline-none focus:border-saas-primary text-white cursor-pointer"
                    >
                  ...
                  {/* Link Family Profile */}
                  <div>
                    <label className="block text-xs font-bold text-white uppercase tracking-wider mb-1">Link Family Profile</label>
                    <select 
            ...
            <div className="bg-saas-card border border-saas-border rounded-2xl p-6 shadow-saas-card space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-saas-border pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-extrabold text-white text-base tracking-tight">Platform Audit Logs</h3>
                    <p className="text-white/70 text-xs mt-0.5">Real-time log of security events and database operations.</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-grow">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-saas-bg border border-saas-border rounded-xl text-xs focus:outline-none focus:border-saas-primary text-white placeholder-saas-text-secondary/60"
                  />
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-bold text-white/70 uppercase whitespace-nowrap">Filter:</span>
                  <select
                    value={auditFilter}
                    onChange={(e) => setAuditFilter(e.target.value)}
                    className="px-3 py-2 bg-saas-bg border border-saas-border rounded-xl text-xs text-white/70 focus:outline-none focus:border-saas-primary cursor-pointer"
                  >
                ...
                {filteredLogs.length > 0 ? (
                  filteredLogs.map(log => (
                    <div key={log.id} className="flex gap-4 p-4.5 bg-saas-bg/40 border border-saas-border/60 rounded-2xl hover:border-saas-border transition-colors">
                      <div className="w-8 h-8 rounded-lg bg-saas-bg border border-saas-border flex items-center justify-center text-white/70 flex-shrink-0">
                      ...
                      <div className="overflow-hidden flex-grow">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                          ...
                          <span className="text-[9px] font-semibold text-white/70">{log.date}</span>
                        </div>
                        <div className="flex items-center gap-3 mt-1.5">
                          <span className="text-[9px] font-bold text-white/70 uppercase tracking-wider">Target: {log.target}</span>
                  ...
                  <div className="p-8 text-center text-white/70/60 italic text-xs border border-dashed border-saas-border rounded-2xl">
