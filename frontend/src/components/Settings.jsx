...
export default function Settings() {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* Title */}
      <div>
        <h1 className="text-3xl font-black text-saas-text-primary tracking-tight">System Settings</h1>
        <p className="text-saas-text-secondary text-sm mt-1">Update personal settings, view roles, and handle administrative security.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-3">
          <div className="bg-saas-card border border-saas-border rounded-2xl p-4 shadow-saas-card space-y-1">
            <h4 className="text-[10px] font-extrabold text-saas-text-secondary uppercase tracking-wider px-3 mb-2">General Settings</h4>
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-bold transition-all text-left cursor-pointer ${
                activeTab === 'account' 
                  ...
                  : 'text-saas-text-secondary hover:bg-saas-bg hover:text-saas-text-primary'
              }`}
            >
          ...
          {activeTab === 'account' && (
            <div className="bg-saas-card border border-saas-border rounded-2xl p-6 shadow-saas-card space-y-6">
              <div className="flex items-center gap-3 border-b border-saas-border pb-4">
                ...
                <div>
                  <h3 className="font-extrabold text-saas-text-primary text-base tracking-tight">Profile & Account</h3>
                  <p className="text-saas-text-secondary text-xs mt-0.5">Overview of your logged-in credentials and family profile link status.</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    <span className="block text-[10px] font-extrabold text-saas-text-secondary uppercase tracking-wider mb-1">Username</span>
                    <div className="px-4 py-2.5 bg-saas-bg border border-saas-border rounded-xl text-xs font-bold text-saas-text-primary">
                      {user?.username}
                    </div>
                  </div>

                  <div>
                    <span className="block text-[10px] font-extrabold text-saas-text-secondary uppercase tracking-wider mb-1">System Privilege</span>
                    <div className="flex items-center gap-2">
                      <span className={`text-[10px] font-black px-2.5 py-1 rounded-lg border uppercase tracking-wider ${
                        isAdmin 
                          ...
                          : 'bg-saas-bg text-saas-text-secondary border-saas-border'
                      }`}>
                ...
                <div className="space-y-4">
                  <span className="block text-[10px] font-extrabold text-saas-text-secondary uppercase tracking-wider mb-1">Linked Genealogy Profile</span>
                    ...
                    <div className="bg-saas-bg/40 border border-saas-border p-4 rounded-xl flex items-center gap-3.5">
                      <div className="w-12 h-12 rounded-xl bg-saas-bg border border-saas-border overflow-hidden flex-shrink-0">
                        {getProfileImage(linkedProfile) ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center font-bold text-xs text-saas-text-secondary">
                            {linkedProfile.fullName.charAt(0)}
                          </div>
                        )}
                      </div>
                      <div>
                        <h4 className="font-bold text-xs text-saas-text-primary">{linkedProfile.fullName}</h4>
                        <span className="text-[9px] font-black text-saas-primary uppercase tracking-wider block mt-0.5">{linkedProfile.relation}</span>
                        <span className="text-[10px] text-saas-text-secondary block mt-1">{linkedProfile.occupation || 'No job specified'}</span>
                      </div>
                    </div>
                  ) : (
          ...
          {activeTab === 'security' && (
            <div className="bg-saas-card border border-saas-border rounded-2xl p-6 shadow-saas-card space-y-6">
              <div className="flex items-center gap-3 border-b border-saas-border pb-4">
                ...
                <div>
                  <h3 className="font-extrabold text-saas-text-primary text-base tracking-tight">Security & Credentials</h3>
                  <p className="text-saas-text-secondary text-xs mt-0.5">Change your system login credentials here to ensure your account security.</p>
                </div>
              </div>
              ...
              <form onSubmit={handlePasswordChange} className="space-y-4 max-w-md">
                ...
                {/* Current password */}
                <div>
                  <label className="block text-xs font-bold text-saas-text-primary uppercase tracking-wider mb-1">Current Password</label>
                  <div className="relative">
                    <input 
                      ...
                      required
                      className="w-full pl-3.5 pr-10 py-2.5 bg-saas-bg border border-saas-border rounded-xl text-sm focus:outline-none focus:border-saas-primary text-saas-text-primary placeholder-saas-text-secondary/60 font-mono"
                      placeholder="Enter current password"
                    />
                    <button
                      type="button"
                      onClick={() => setShowCurrentPassword(!showCurrentPassword)}
                      className="absolute right-3 top-3.5 text-saas-text-secondary hover:text-saas-text-primary"
                    >
                ...
                {/* New password */}
                <div>
                  <label className="block text-xs font-bold text-saas-text-primary uppercase tracking-wider mb-1">New Password</label>
                  <div className="relative">
                    <input 
                ...
                <div>
                  <label className="block text-xs font-bold text-saas-text-primary uppercase tracking-wider mb-1">Confirm New Password</label>
                  <input 
                    type="password"
                    value={passwordData.confirmPassword}
                    onChange={(e) => setPasswordData(prev => ({ ...prev, confirmPassword: e.target.value }))}
                    required
                    className="w-full px-3.5 py-2.5 bg-saas-bg border border-saas-border rounded-xl text-sm focus:outline-none focus:border-saas-primary text-saas-text-primary placeholder-saas-text-secondary/60 font-mono"
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-gradient-to-r from-saas-primary to-saas-accent hover:opacity-95 text-white rounded-xl text-xs font-bold shadow-lg shadow-saas-primary/10 transition-all cursor-pointer flex items-center justify-center gap-2"
                >
          ...
          {activeTab === 'users' && isAdmin && (
            <div className="bg-saas-card border border-saas-border rounded-2xl p-6 shadow-saas-card space-y-6">
              <div className="flex items-center gap-3 border-b border-saas-border pb-4">
                ...
                <div>
                  <h3 className="font-extrabold text-saas-text-primary text-base tracking-tight">Register Family Login</h3>
                  <p className="text-saas-text-secondary text-xs mt-0.5">Create software access credentials and link them to family genealogy profile nodes.</p>
                </div>
              </div>
              ...
              <form onSubmit={handleRegisterUser} className="space-y-4 max-w-xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {/* Username */}
                  <div>
                    <label className="block text-xs font-bold text-saas-text-primary uppercase tracking-wider mb-1">Username</label>
                    <input 
                      type="text"
                  ...
                  {/* Password */}
                  <div>
                    <label className="block text-xs font-bold text-saas-text-primary uppercase tracking-wider mb-1">Password</label>
                    <input 
                      type="password"
                  ...
                  {/* System Role */}
                  <div>
                    <label className="block text-xs font-bold text-saas-text-primary uppercase tracking-wider mb-1">System Role</label>
                    <select 
                      value={regData.role}
                  ...
                  {/* Link Family Profile */}
                  <div>
                    <label className="block text-xs font-bold text-saas-text-primary uppercase tracking-wider mb-1">Link Family Profile</label>
                    <select 
            ...
            <div className="bg-saas-card border border-saas-border rounded-2xl p-6 shadow-saas-card space-y-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-saas-border pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-extrabold text-saas-text-primary text-base tracking-tight">Platform Audit Logs</h3>
                    <p className="text-saas-text-secondary text-xs mt-0.5">Real-time log of security events and database operations.</p>
                  </div>
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-grow">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 bg-saas-bg border border-saas-border rounded-xl text-xs focus:outline-none focus:border-saas-primary text-saas-text-primary placeholder-saas-text-secondary/60"
                  />
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-[10px] font-bold text-saas-text-secondary uppercase whitespace-nowrap">Filter:</span>
                  <select
                    value={auditFilter}
                    onChange={(e) => setAuditFilter(e.target.value)}
                    className="px-3 py-2 bg-saas-bg border border-saas-border rounded-xl text-xs text-saas-text-secondary focus:outline-none focus:border-saas-primary cursor-pointer"
                  >
                ...
                {filteredLogs.length > 0 ? (
                  filteredLogs.map(log => (
                    <div key={log.id} className="flex gap-4 p-4.5 bg-saas-bg/40 border border-saas-border/60 rounded-2xl hover:border-saas-border transition-colors">
                      <div className="w-8 h-8 rounded-lg bg-saas-bg border border-saas-border flex items-center justify-center text-saas-text-secondary flex-shrink-0">
                        <log.icon className="w-4 h-4" />
                      </div>
                      <div className="overflow-hidden flex-grow">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                          <p className="text-xs text-saas-text-primary leading-tight font-bold">
                            <span className="text-saas-primary font-black">{log.user}</span> {log.action}
                          </p>
                          <span className="text-[9px] font-semibold text-saas-text-secondary">{log.date}</span>
                        </div>
                        <div className="flex items-center gap-3 mt-1.5">
                          <span className="text-[9px] font-bold text-saas-text-secondary uppercase tracking-wider">Target: {log.target}</span>
                  ...
                  <div className="p-8 text-center text-saas-text-secondary/60 italic text-xs border border-dashed border-saas-border rounded-2xl">
