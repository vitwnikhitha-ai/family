    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-white/70 text-sm mt-1">View, manage, and edit details of all family members in the Maddali registry.</p>
        </div>
      ...
      <div className="mt-6">
        {loading ? (
          <div className="bg-saas-card rounded-2xl border border-saas-border p-12 text-center text-white/70 space-y-4">
          ...
          <div className="bg-saas-card rounded-2xl border border-saas-border p-16 text-center text-white/70">
            <FileSpreadsheet className="w-10 h-10 mx-auto mb-3 text-white/70 opacity-60" />
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-5 border-b border-saas-border">
                <div>
                  ...
                  <p className="text-white/70 text-xs mt-1">Fill out the detailed family relationship and personal records.</p>
                </div>
                <button 
                  onClick={() => navigate('/members')}
                  className="p-2.5 rounded-xl hover:bg-saas-bg text-white/70 hover:text-white border border-saas-border transition-all cursor-pointer"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit} className="flex-grow overflow-y-auto px-6 py-6 space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {/* Relation */}
                  <div>
                    <label className="block text-xs font-bold text-white uppercase tracking-wider mb-1">Relation to Self</label>
                    <select 
                      name="relation"
                  ...
                  {/* Gender */}
                  <div>
                    <label className="block text-xs font-bold text-white uppercase tracking-wider mb-1">Gender</label>
                    <select 
                      name="gender"
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      <label className="block text-xs font-bold text-white uppercase tracking-wider">Date of Birth</label>
                      <label className="flex items-center gap-1 cursor-pointer select-none">
                        ...
                        />
                        <span className="text-[10px] text-white/70 font-bold uppercase tracking-wider">Private</span>
                      </label>
                    </div>
                    <input 
                      type="date" 
                      ...
                      onChange={handleInputChange}
                      className="w-full px-3.5 py-2.5 bg-saas-bg border border-saas-border rounded-xl text-sm focus:outline-none focus:border-saas-primary text-white"
                    />
                  </div>

                  {/* Marital Status */}
                  <div>
                    <label className="block text-xs font-bold text-white uppercase tracking-wider mb-1">Marital Status</label>
                    <select 
                      name="maritalStatus"
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      <label className="block text-xs font-bold text-white uppercase tracking-wider">Phone Number</label>
                      <label className="flex items-center gap-1 cursor-pointer select-none">
                        <input 
                          type="checkbox" 
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      <label className="block text-xs font-bold text-white uppercase tracking-wider">Aadhaar (Secure)</label>
                      <label className="flex items-center gap-1 cursor-pointer select-none">
                        <input 
                          type="checkbox" 
                    ...
                    <input 
                      ...
                      onChange={handleInputChange}
                      maxLength={12}
                      className="w-full px-3.5 py-2.5 bg-saas-bg border border-saas-border rounded-xl text-sm font-mono focus:outline-none focus:border-saas-primary text-white placeholder-saas-text-secondary/60"
                  ...
                  <div className="col-span-2">
                    <div className="flex justify-between items-center mb-1">
                      <label className="block text-xs font-bold text-white uppercase tracking-wider">Occupation</label>
                      <label className="flex items-center gap-1 cursor-pointer select-none">
                        <input 
                          type="checkbox" 
                  ...
                  <div className="col-span-2">
                    <div className="flex justify-between items-center mb-1">
                      <label className="block text-xs font-bold text-white uppercase tracking-wider">Address</label>
                      <label className="flex items-center gap-1 cursor-pointer select-none">
                        <input 
                          type="checkbox" 
                ...
                <div className="border-t border-saas-border pt-4 mt-2 space-y-3">
                  <div className="flex justify-between items-center">
                    <h4 className="font-extrabold text-white text-xs uppercase tracking-wider">Custom Fields</h4>
                    <button
                      type="button"
                  ...
                  {customFields.length > 0 ? (
                        ...
                        <div key={idx} className="flex gap-2 items-center bg-saas-bg/40 p-3 rounded-xl border border-saas-border">
                          ...
                          <div className="flex-1">
                            <input
                              ...
                              className="w-full px-2.5 py-1.5 bg-saas-bg border border-saas-border rounded-lg text-xs focus:outline-none focus:border-saas-primary text-white placeholder-saas-text-secondary/60"
                            />
                          </div>
                          ...
                          <label className="flex items-center gap-1 cursor-pointer select-none px-1">
                            <input
                              ...
                              className="w-3.5 h-3.5 text-saas-primary border-saas-border rounded focus:ring-saas-primary"
                            />
                            <span className="text-[9px] text-white/70 font-bold uppercase whitespace-nowrap">Private</span>
                          </label>
                          ...
                          <button
                            ...
                            className="p-1.5 rounded-lg text-white/70 hover:text-rose-500 hover:bg-saas-bg border border-transparent hover:border-saas-border transition-colors cursor-pointer"
                          >
                            <X className="w-4 h-4" />
                          </button>
                        </div>
                    ...
                    <p className="text-[10px] text-white/70/60 italic leading-normal">No custom fields added yet. Click "Add Field" to attach extra data (e.g. Blood Group, PAN Card, Passport).</p>
                  )}
                </div>

                {/* Relationship Links */}
                <div className="border-t border-saas-border pt-4 mt-2 space-y-3">
                  <h4 className="font-extrabold text-white text-xs uppercase tracking-wider">Relationship Connections</h4>

                  <div className="grid grid-cols-2 gap-4">
                    {/* Father */}
                    <div>
                      <label className="block text-xs font-bold text-white uppercase tracking-wider mb-1">Father</label>
                      <select 
                        name="father"
                    ...
                    {/* Mother */}
                    <div>
                      <label className="block text-xs font-bold text-white uppercase tracking-wider mb-1">Mother</label>
                      <select 
                        name="mother"
                    ...
                    {/* Spouse */}
                    <div className="col-span-2">
                      <label className="block text-xs font-bold text-white uppercase tracking-wider mb-1">Spouse</label>
                      <select 
                        name="spouse"
              ...
              <div className="border-t border-saas-border px-6 py-4 flex items-center justify-end gap-3 bg-saas-bg/30">
                <button 
                  type="button"
                  onClick={() => navigate('/members')}
                  className="px-4 py-2 border border-saas-border rounded-xl text-xs font-bold text-white/70 hover:bg-saas-bg hover:text-white transition-colors cursor-pointer"
                >
                  Cancel
                </button>
                <button 
